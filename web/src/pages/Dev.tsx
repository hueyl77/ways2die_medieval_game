  ...
  return (
    <div className="h-full grid grid-rows-[auto_1fr_auto] lg:grid-cols-[minmax(0,1fr)_320px] relative overflow-hidden">
      ...
      <main className="relative min-h-0 min-w-0 p-2">
        ...
        {view.phase === 'funeral' && isGhost && !me.willSealed && view.succession.length > 0 && <FuneralModal view={view} busy={false} onHide={() => {}} onSeal={(h) => { sealWill(stateRef.current, me.index, h, now); settle(); }} />}
