...
export type LogEvent =
  ...
  | { t: 'gold'; trade: Trade; delta: number; by: string; from?: Trade; absorbed?: boolean }
...
export interface SeatView {
  ...
  revealedTrade: Trade | null; locked: boolean; ready: boolean; ack: boolean;
