...
Each player secretly runs one of twelve trades. Gold is earned **by trades, not by players**, on a public board — so every coin you bank is also a clue about who you are.
...
1. Place the gold board in the center; set all 12 gold markers to 0.
...
- **Scoring cards** (Blackmail, Sunday Best) stay face-up in front of the player they hit and are applied to *that player's own trade* at final scoring — whatever trade that turns out to be.
...
- Tracks of absent trades are normal targets. Nobody knows which tracks those are — a climbing track might be a bluff, a Gleaning, a False Colors… or a real neighbor getting rich.
...
**🧵 Tailor**
- **False Colors** — Banks 1 gold to any track of the pile owner's choice.
- **Cloak of Plain Cloth** — Next round, all Attacks revealed in this pile are voided.
...
- **Snare** — Stays on the pile: the next Attack revealed here is voided, and when it springs, the Hunter track gains 1.
...
*Silver Dagger, Sneak Attack, Hunting Bow, Felling Axe, and Broken Door count as Attacks for every rule and truth card.*
...
- **Truth cards are binding.** Answers to Inquest, Appraisal, and Tracks in the Snow must be honest, and a drunk shows their whole hand. Everything else may be a lie.
...
- **Do bonuses stack?** Yes — Trestle Market during Market Fair banks +2 over the base.
- **Deep Forest is announced a round ahead — do we still place there?** Yes. Everyone must feed the void one card. Choose your sacrifice.
...
- **Does the Felling Axe remove wounds or scoring cards?** No. Only pending and persistent cards on the pile.
- **How do I heal a Calamity?** A Heal removes its wound token first; the card stays as one wound until healed again.
- **What does "cannot be voided by a Protect" cover?** Protect cards and the Palisade. Snares, Night Patrol, Curfew, Cloak of Plain Cloth, and Deep Forest still stop a Silver Dagger or Sneak Attack.
